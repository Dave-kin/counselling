                        ...
                        <div class="row">
                            ...
                            <form id="contact" action="" method="post">
                                ...
                                <div class="col-lg-4">
                                    <fieldset>
                                        <label>Name</label>
                                    <input name="Full_name" type="text" required disabled>
                                </fieldset>
                                </div>
                                <div class="col-lg-4">
                                    <fieldset>
                                        <label>Data of Bierth</label>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input name="per-address" type="text" placeholder="address...*" required>
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                    <button type="submit" name="form-submit" class="button">Submit</button>
                                    </fieldset>
                                </div>
                                </div>
                            </form>
